...
export const metadata: Metadata = { title: 'Imóveis na Trindade São Gonçalo — Casas e Apartamentos', description: 'Casas e apartamentos para alugar ou comprar no bairro Trindade em São Gonçalo/RJ.', openGraph: { title: 'Imóveis na Trindade', description: 'Casas e apartamentos no bairro Trindade em São Gonçalo/RJ.', url: 'https://trindadeonline.com.br/imoveis' } }
...
const EMOJI = '🏠'; const TITLE = 'Imóveis'
...
export default function ImóveisPage(){
  ...
  return(<>
    ...
    {showForm&&<FormModal subtypes={SUBTYPES} type="imovel" userId={userId!} onClose={()=>setShowForm(false)} onSaved={()=>{setShowForm(false);load()}}/>}
  </>)
}
