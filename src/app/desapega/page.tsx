...
const EMOJI = '🏷️'; const TITLE = 'Desapega'
...
export default function DesapegaPage(){
  ...
  return(<>
    ...
    {showForm&&<FormModal subtypes={SUBTYPES} type="desapega" userId={userId!} onClose={()=>setShowForm(false)} onSaved={()=>{setShowForm(false);load()}}/>}
  </>)
}
