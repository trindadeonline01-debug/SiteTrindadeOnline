...
const EMOJI = '🔍'; const TITLE = 'Achados & Perdidos'
...
export default function AchadosPagePage(){
  ...
  return(<>
    ...
    {showForm&&<FormModal subtypes={SUBTYPES} type="achado" userId={userId!} onClose={()=>setShowForm(false)} onSaved={()=>{setShowForm(false);load()}}/>}
  </>)
}
