...
// generateMetadata de page.tsx usa a URL dela direto (mesmo motivo do
// /empresa/[slug]/opengraph-image.tsx: Satori não decodifica webp).
    ...
    (
      <div style={{ width: '100%', height: '100%', display: 'flex', position: 'relative', background: '#111111' }}>
        ...
        >
          ...
          <div style={{ display: 'flex', fontSize: 26, color: '#FFC531', marginTop: 10, maxWidth: 1000 }}>📋 Cardápio digital</div>
        </div>
      </div>
    ),
    { ...size }
