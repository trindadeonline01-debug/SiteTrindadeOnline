...
async function registerPushToken() {
  try {
    if (window.location.hostname === 'trindadeonline.com.br') { window.location.href = window.location.href.replace('trindadeonline.com.br', 'www.trindadeonline.com.br'); return; }
